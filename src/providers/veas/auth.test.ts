...
describe('VeasAuthProvider', () => {
  ...
  describe('authenticate', () => {
    ...
    it('should handle authentication failure', async () => {
      ...
      await expect(authProvider.authenticate(credentials)).rejects.toThrow('Authentication failed: 401 Unauthorized')
    })
    ...
    it('should handle network errors', async () => {
      ...
      await expect(authProvider.authenticate(credentials)).rejects.toThrow('Network error')
    })
    ...
    it('should throw error for unsupported credentials', async () => {
      ...
      await expect(authProvider.authenticate(credentials)).rejects.toThrow('Unsupported authentication method')
    })
