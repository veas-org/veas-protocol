...
export function generateCommunicationTools(protocol: CommunicationProtocol): MCPTool[] {
  ...
  tools.push(
    createTool({
      ...
      handler: async (params) => protocol.getChannelByContext('project', params.project_identifier, params.workspace_id, params),
      inputSchema: {
  ...
  tools.push(
    createTool({
      ...
      handler: async (params) => protocol.createChannel({
  ...
  tools.push(
    createTool({
      ...
      handler: async (params) => {
        const response = await protocol.getMessagesByIssue(
          params.channel_id,
  ...
  tools.push(
    createPaginatedTool({
      ...
      handler: async (params) => protocol.searchMessages({
        query: params.query,
        workspaceId: params.workspace_id,
  ...
  tools.push(
    createTool({
      ...
      handler: async (params) => protocol.addReaction({
